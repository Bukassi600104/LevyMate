...
const whatsapp_parser_1 = require("../../services/whatsapp-parser");
describe("WhatsApp Parser", () => {
    it("should extract amounts with naira symbol", () => {
        const text = "I sold items for ₦5000 today";
        const result = (0, whatsapp_parser_1.parseWhatsAppText)(text);
...
//# sourceMappingURL=whatsapp-parser.test.js.map