...
describe("Tax Engine", () => {
    ...
    it("should calculate tax for income in first band (tax-free)", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(500000, // income
        0, // expenses
        0, // rent
        taxRules2025);
    ...
    it("should calculate tax for income in second band (15%)", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(2000000, // income: 800k (0%) + 1.2m (15%)
        0, 0, taxRules2025);
    ...
    it("should apply rent deduction correctly", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(2000000, // income
        0, // no expenses
        500000, // rent paid
        taxRules2025);
    ...
    it("should apply rent relief cap correctly", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(5000000, // income
        0, 3000000, // rent paid (exceeds cap)
        taxRules2025);
    ...
    it("should handle multi-band income correctly", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(30000000, // crosses multiple bands
        0, 0, taxRules2025);
        // Band 1: 800k * 0% = 0
    ...
    it("should return zero tax for negative taxable income", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(1000000, // income
    ...
    it("should include default rule version in output", () => {
        const result = (0, tax_engine_1.calculateTaxEstimate)(2000000, 0, 0, taxRules2025);
        expect(result.rule_version).toBe("2025-v1");
    });
});
//# sourceMappingURL=tax-engine.test.js.map